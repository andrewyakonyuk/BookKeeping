...
namespace BookKeeping.Core.Storage
{
    ...
    public class OptimisticConcurrencyException : Exception
    {
        ...
        private OptimisticConcurrencyException(string message, long actualVersion, long expectedVersion, IIdentity id,
    ...
    public class RealConcurrencyException : Exception
    {
        ...
        public RealConcurrencyException(string message)
            : base(message)
        {
        }

        public RealConcurrencyException(string message, Exception inner)
            : base(message, inner)
        {
        }
