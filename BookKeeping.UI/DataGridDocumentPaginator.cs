...
{
    public class DataGridDocumentPaginator : DocumentPaginator
    {
        ...
        public DataGridDocumentPaginator(DataGrid documentSource, string documentTitle, Size pageSize, Thickness pageMargin)
        {
        ...
        private object CreateTable(bool createRowDefinitions)
        {
            ...
            if (_documentSource.Columns != null)
            {
                double totalColumnWidth = _documentSource.Columns.Sum(column => column.Visibility == Visibility.Visible ? column.Width.DesiredValue : 0);
        ...
        {
            double proportion = column.Width.DesiredValue / (this.PageSize.Width - (this.PageMargin.Left + this.PageMargin.Right));
            ...
            text.Text = column.Header == null ? string.Empty : column.Header.ToString();
