...
namespace BookKeeping.UI
{
    public abstract class TreeNode<T>
        where T : TreeNode<T>
    {
        private readonly ICollection<T> ancestors = new ObservableCollection<T>();
        private readonly ICollection<T> children = new ObservableCollection<T>();
        private readonly ICollection<T> descendants = new ObservableCollection<T>();
